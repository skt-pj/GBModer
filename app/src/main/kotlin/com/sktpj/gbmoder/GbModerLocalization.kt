...
object GbModerLocalization {
    private val exact = mapOf(
        ...
        "出力先フォルダを選択" to R.string.conversion_output_folder_select,
        "対応していないファイル形式です" to R.string.unsupported_file_type,
        "変換しました" to R.string.conversion_completed,
        "変換完了" to R.string.conversion_complete_title,
        "ファイルを開く" to R.string.conversion_open_file,
        "このファイルを開けるアプリがありません" to R.string.conversion_open_unavailable,
        "出力先フォルダの権限を保存できませんでした" to R.string.conversion_folder_permission_failed,
