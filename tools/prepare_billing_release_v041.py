...
for command in (
    ...
    [sys.executable, str(repo / "tools/finish_2048_main_v045.py"), str(generated_root)],
    [sys.executable, str(repo / "tools/finish_fit_resolution_ui_v047.py"), str(generated_root)],
):
