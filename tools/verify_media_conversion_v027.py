...
need(compose, "painterResource(R.drawable.ic_photo_24)", "photo icon")
need(compose, "painterResource(R.drawable.ic_video_24)", "video icon")
need(compose, "painterResource(R.drawable.ic_3d_model_24)", "model icon")
