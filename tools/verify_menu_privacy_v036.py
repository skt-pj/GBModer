...
require("version.properties", "VERSION_NAME=0.1.36", "version name")
require("version.properties", "VERSION_CODE=37", "version code")
...
print("MENU + PRIVACY + ACCESSIBILITY DISCLOSURE v0.1.36 AUTOMATED GATE: PASS")
