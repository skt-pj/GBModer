...
need(main, "uiTextRecognitionEnabled = textRecognitionEnabled;", "text state applied at start")
...
need(compose, 'title = "文字を読みやすくする"', "text recognition in normal settings")
need(compose, 'tag = "text-recognition-row"', "text recognition test tag")
...
print("UIUX v0.1.26 AUTOMATED GATE: PASS")
